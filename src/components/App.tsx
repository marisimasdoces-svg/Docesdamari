...
export default function App() {
  ...
  useEffect(() => {
    ...
    // APP_V6_WAIT_FIREBASE_FINANCIAL_2026_08_18
    // Na abertura, utilitySettings começa vazio até o Firebase hidratar.
    // Não criar um financial-settings local nesse intervalo: ele receberia
    // updatedAt mais novo e poderia vencer o registro real vindo da nuvem,
    // fazendo saldo/PIX parecerem resetados para zero.
    if (!financial) return;
